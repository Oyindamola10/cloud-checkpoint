...
const Contact = () => {
  ...
  <div className="col-md-4">
    ...
    <input type="text" className="form-control" id="validationCustom01" ></input>
  ...
  <div className="col-md-4">
    ...
    <input type="text" className="form-control" id="validationCustom02"></input>
    <div className="valid-feedback">
      Looks good!
    </div>
  </div>
  ...
  <div className="col-md-6">
    <label for="validationCustom03" classN="form-label">City</label>
